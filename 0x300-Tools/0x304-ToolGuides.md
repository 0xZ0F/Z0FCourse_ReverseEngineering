...
* **Log** is just logging information for x64dbg and cant be ignored for pretty much everything.
...
### Register Window
Shows all registers. You can right click the registers and do thing with/to them.
